...
DATASET_CONFIGS = {
    ...
    # -------------------------------------------------------------------
    "icd_ner": {
        "hf_name": "composite:ncbi_disease+bc5cdr+biomed_ner+ade_corpus+curated+medmentions+maccrobat+discharge",
        "description": (
            "ICD-focused composite NER dataset. Combines eight sources with "
